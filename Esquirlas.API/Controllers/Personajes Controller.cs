...
namespace Esquirlas.API.Controllers
{
    ...
    [ApiController]
    public class Personajes_Controller : ControllerBase
    {
        private readonly IPersonajes_Services personajes_Services;

        public Personajes_Controller(IPersonajes_Services personajes_Services)
        {
        ...
        {
            var response = personajes_Services.GetAllFilter(request);
